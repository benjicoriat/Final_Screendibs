...
class ReportGeneratorService:
        ...
        if plan_type == PlanType.BASIC:
            ...
            sections = [
                ...
                (
                    ...
                    "Examination of prose style, narrative voice, and literary devices",
                ),
            ...
            sections = [
                ...
                (
                    ...
                    "Deeper meanings through psychological and philosophical lenses",
                ),
    ...
    def generate_book_stats(self, book: str, author: str) -> List[Dict[str, str]]:
...
Return ONLY valid JSON, no other text."""
        ...
        try:
            ...
            result: List[Dict[str, str]] = json.loads(content)
            return result
...
Write ONLY the content, no titles or labels. Begin immediately with insightful analysis."""
        ...
        try:
            ...
            result = "Content unavailable for this section due to an upstream generation error."
            return result
